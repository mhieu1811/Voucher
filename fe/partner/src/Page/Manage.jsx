...
export default function Manage() {
    ...
    console.log(maP)
    useEffect(async()=>{
        Axios.post("https://oka2-hv.herokuapp.com/partner/list",{partner:maP}).then((respone)=>{setlist(respone.data)})
    ...
    async function onClick(){
        const ds_search = await Axios.post("https://oka2-hv.herokuapp.com/partner/search",{ma:search}).then((respone)=>{return respone.data})
