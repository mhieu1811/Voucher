...
export default function Login(props) {
    ...
    async function onClick(){
        const login = await Axios.post('https://rental-apartment-huflit.herokuapp.com/api/partner/signin',{username:username,password:pass}).then((respone)=>{
            return respone.data
        })
        if(login!="Không có người dùng này")
        {
            props.setLogin(login,'partner')
            history.push("/")
        }
