...
export default function Login(props) {
    ...
    async function onClick(){
        ...
        // history.push("/")
        // e.preventDefault();
        const login = await Axios.post('https://rental-apartment-huflit.herokuapp.com/api/customer/signin',{ma:true,username:username,password:pass}).then((respone)=>{
            return respone.data
        })
        if(login!="Không có người dùng này")
        {
            props.setLogin(login,'kh')
            history.push("/")
        }
